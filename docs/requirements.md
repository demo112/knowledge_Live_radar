...
> **重要**：本文档基于 [核心哲学文档](./core-philosophy.md) 编写。所有需求都必须符合AI-First、Human-in-the-Loop、Evolution-Driven三大原则。
...
> 完整哲学请参考 [核心哲学文档](./core-philosophy.md)
...
1. **智能优先于手动**：能让AI做的，就不让人做
2. **即时反馈优于异步处理**：用户应立即看到AI结果
3. **透明优于黑盒**：AI推理过程必须可见
4. **质量优于数量**：宁缺毋滥
5. **协作优于自动化**：追求最佳人机协作，而非完全自动化
