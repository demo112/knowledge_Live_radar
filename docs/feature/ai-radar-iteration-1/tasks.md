...
- [ ] 7. Checkpoint - 确保服务层测试通过
  - 运行所有测试，确保服务层逻辑正确
  - 如有问题请询问用户

- [ ] 8. 信息源服务层实现
  - [ ] 8.1 实现 SourceService 核心方法
