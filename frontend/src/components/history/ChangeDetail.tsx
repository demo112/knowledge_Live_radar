        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
              <span className="text-sm text-gray-500 dark:text-gray-400 block mb-1">Time</span>
              <span className="font-medium">{formatDate(change.created_at)}</span>
            </div>
            <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
              <span className="text-sm text-gray-500 dark:text-gray-400 block mb-1">Applicant</span>
            ...
            {change.reason && (
              <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg md:col-span-2">
                <span className="text-sm text-gray-500 dark:text-gray-400 block mb-1">Reason</span>
          ...
          {change.impact_analysis && (
            <div>
              <h3 className="text-lg font-semibold mb-3 text-gray-900 dark:text-white">Impact Analysis</h3>
              <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg border border-blue-100 dark:border-blue-800">
                <div className="flex items-center gap-4 mb-2">
                   <span className="text-sm font-semibold text-blue-800 dark:text-blue-300">
                     Risk: {change.impact_analysis.risk_level}
                   </span>
                   <span className="text-sm text-blue-700 dark:text-blue-400">
                     Affected Nodes: {change.impact_analysis.affected_nodes_count}
                   </span>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold mb-3 text-gray-900 dark:text-white">Change Data</h3>
            ...
            {change.original_data && (
              <div>
                <h3 className="text-lg font-semibold mb-3 text-gray-900 dark:text-white">Original Data (Snapshot)</h3>
                <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg overflow-x-auto max-h-60 border border-gray-200 dark:border-gray-700">
